...
- **Refatoração de Variáveis & URL de Produção**: Substituídos todos os mapeamentos de variáveis globais de process.env para o padrão ESM do Vite (import.meta.env) e sintonizada a URL definitiva de produção para a nova API do Google Apps Script (`https://script.google.com/macros/s/AKfycbwXt-KyiVYzIUu0R-O-WQKgHtEeM3Z3uGllCJuEnYr-iSmhcdsEk4xPE1GApVBSOK86rQ/exec`).
